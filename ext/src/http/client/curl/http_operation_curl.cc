...
std::future<long> &HttpOperation::SendAsync(std::function<void(HttpOperation &)> callback)
{
 ...
 */
uint16_t HttpOperation::GetResponseCode()
{
  return res_;
}
 ...
 */
opentelemetry::ext::http::client::SessionState HttpOperation::GetSessionState()
{
 ...
 */
bool HttpOperation::WasAborted()
{
  return is_aborted_.load();
}
 ...
 * @return
 */
std::vector<uint8_t> HttpOperation::GetResponseBody()
{
  return resp_body_;
}
 ...
 * @return
 */
std::vector<uint8_t> HttpOperation::GetRawResponse()
{
 ...
 * @return
 */
int HttpOperation::WaitOnSocket(curl_socket_t sockfd, int for_recv, long timeout_ms)
{
  struct timeval tv;
 ...
 * @return
 */
size_t HttpOperation::WriteVectorCallback(void *ptr,
                                          size_t size,
                                          size_t nmemb,
